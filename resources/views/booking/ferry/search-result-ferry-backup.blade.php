...
.seat.booked {
    ...
    pointer-events: none;
            ...
            #seat_div .col-xs-1,#seat_div .col-sm-1,#seat_div .col-md-1,#seat_div .col-lg-1,#seat_div .col-xs-2,#seat_div .col-sm-2,#seat_div .col-md-2,#seat_div .col-lg-2,#seat_div .col-xs-3,#seat_div .col-sm-3,#seat_div .col-md-3,#seat_div .col-lg-3,#seat_div .col-xs-4,#seat_div .col-sm-4,#seat_div .col-md-4,#seat_div .col-lg-4,#seat_div .col-xs-5,#seat_div .col-sm-5,#seat_div .col-md-5,#seat_div .col-lg-5,#seat_div .col-xs-6,#seat_div .col-sm-6,#seat_div .col-md-6,#seat_div .col-lg-6,#seat_div .col-xs-7,#seat_div .col-sm-7,#seat_div .col-md-7,#seat_div .col-lg-7,#seat_div .col-xs-8,#seat_div .col-sm-8,#seat_div .col-md-8,#seat_div .col-lg-8,#seat_div .col-xs-9,#seat_div .col-sm-9,#seat_div .col-md-9,#seat_div .col-lg-9,#seat_div .col-xs-10,#seat_div .col-sm-10,#seat_div .col-md-10,#seat_div .col-lg-10,#seat_div .col-xs-11,#seat_div .col-sm-11,#seat_div .col-md-11,#seat_div .col-lg-11,#seat_div .col-xs-12,#seat_div .col-sm-12,#seat_div .col-md-12,#seat_div .col-lg-12 {
                position: relative;
                min-height: 1px;
                padding-right: 15px;
                padding-left: 15px
            ...
            #seat_div .col-xs-1,#seat_div .col-xs-2,#seat_div .col-xs-3,#seat_div .col-xs-4,#seat_div .col-xs-5,#seat_div .col-xs-6,#seat_div .col-xs-7,#seat_div .col-xs-8,#seat_div .col-xs-9,#seat_div .col-xs-10,#seat_div .col-xs-11,#seat_div .col-xs-12 {
                float: left
            }
            ...
            @media (max-width: 768px) {
                ...
                #seat_div .box-body .col-xs-12,
                #seat_div .box-body .col-xs-12 .col-xs-5,
                #seat_div .box-body .col-xs-12 .col-xs-5 .col-xs-12{
                    padding: 0;
                }
                    ...
                    <div class="modal-body p-0">
                        <div class="">
                            <div class="row py-4">
                                <div class="col-4 d-flex justify-content-center">
                                    <div class="seat me-1"></div>
                                    <span class="m-0">Vaccant</span>
                                </div>
                                <div class="col-4 d-flex justify-content-center">
                                    <div class="seat selected me-1"></div>
                                    <span class="m-0">Selected</span>
                                </div>
                                <div class="col-4 d-flex justify-content-center">
                                    <div class="seat booked me-1"></div>
                                    <span class="m-0">Booked</span>
                                </div>
                            </div>
                        </div>
                                                            ...
                                                            <div class="ferryCard ferrySearch mb-3">
                                                                ...
                                                                <div class="ferryDetails ms-3 ">
                                                                    <div class="ferryName">
                                                                        ...
                                                                        <p class="mb-3">
                                                                            Arrival Time
                                                                            {{ isset($shipSchedule['arrival_time']) ? date('H:i', strtotime($shipSchedule['arrival_time'])) : 'N/A' }}
                                                                        </p>
                                                                        <p class="mb-3">
                                                            ...
                                                            <div class="ferryCard ferrySearch mb-3">
                                                                ...
                                                                <div class="ferryDetails ms-3 ">
                                                                    ...
                                                                    <div class="ferryName">
                                                                        ...
                                                                        <p class="mb-3">
                                                                            Arrival Time
                                                                            {{ isset($shipSchedule['ship_class'][0]->arrival_time) ? date('H:i', strtotime($shipSchedule['ship_class'][0]->arrival_time)) : 'N/A' }}
                                                                        </p>
                                                                    ...
                                                                    <div class="classBtn">
                                                                        @foreach ($shipSchedule['ship_class'] as $ferryPrice)
                                                                            <a href="#"
                                                                                id="{{ 'ferry_' . ($ferryPrice->ship_class_title ?? 'Standard') . '_' . $key + 1 }}"
                                                                                data-ferryschedule-id="{{ $ferryPrice->id }}"
                                                                                data-class_id="{{ $ferryPrice->ship_class_id ?? 'N/A' }}"
                                                                                data-from="{{ $ferryPrice->source_name ?? 'N/A' }}"
                                                                                data-to="{{ $ferryPrice->destination_name ?? 'N/A' }}"
                                                                                ...
                                                                                class="btn {{ $ferryPrice->ship_class_title ?? 'Standard' }}  ferry-btn mb-2">
                                                                                <p class="text-white mb-0">
                                                                                    {{ $ferryPrice->ship_class_title ?? 'Standard' }}
                                                                                </p>
                                                                                <p class="text-white mb-0"
                                                                                    style="text-decoration: line-through;">
                                                                                    ₹ {{ $ferryPrice->ship_class_price ?? 0 }}
                                                                                </p>
                                                                                <p class="text-white mb-0">
                                                                                    ₹
                                                                                    {{ ($ferryPrice->ship_class_price ?? 0) - 100 }}
                                                                                </p>
                                                                                <p class="text-white mb-0">
                                                                                    Seat: {{ $ferryPrice->seat ?? 0 }}
                                                                                </p>
                                                                                <p class="bg-green-text-white mb-0">
                                                                                    Book Now
                                                                                </p>
                                                            ...
                                                            <div class="ferryCard ferrySearch mb-3">
                                                                ...
                                                                <div class="ferryDetails ms-3 ">
                                                                    ...
                                                                    <div class="classBtn">
                                                                        @foreach ($shipSchedule['ship_class'] as $ferryPrice)
                                                                            <a href="#"
                                                                                id="{{ 'ferry_' . ($ferryPrice->class_name ?? 'Standard') . '_' . $key + 1 }}"
                                                                                ...
                                                                                class="btn {{ $ferryPrice->class_name ?? 'Standard' }}  ferry-btn mb-2">
                                                                                <p class="text-white mb-0">
                                                                                    {{ $ferryPrice->class_name ?? 'Standard' }}
                                                                                </p>
                                                                                <p class="text-white mb-0">
                                                                                    ₹ {{ $ferryPrice->adult_seat_rate ?? 0 }}
                                                                                </p>
                                                                                <!-- <p class="text-white mb-0">
                                                                                    ₹
                                                                                    {{ ($ferryPrice->adult_seat_rate ?? 0) - 100 }}
                                                                                </p> -->
                                                                                <p class="text-white mb-0">
                                                                                    Seat: {{ $ferryPrice->seat_available ?? 0 }}
                                                                                </p>
                                                                                <p class="bg-green-text-white mb-0">
                                                                                    Book Now
                                                                                </p>
                                                                        ...
                                                                        <div class="classBtn">
                                                                            @foreach ($shipSchedule['ship_class'] as $ferryPrice)
                                                                                <a href="#"
                                                                                    ...
                                                                                    data-avl_seat="{{ $ferryPrice->seat ?? 0 }}"
                                                                                    data-ship_name="{{ 'Makruzz' }}"
                                                                                    class="btn {{ $ferryPrice->ship_class_title ?? 'Standard' }} ferry-btn2 mb-2">
                                                                                    <p class="text-white mb-0">
                                                                                        {{ $ferryPrice->ship_class_title ?? 'Standard' }}
                                                                                    </p>
                                                                                    <p class="text-white mb-0"
                                                                    ...
                                                                    <div class="ferryDetails ms-3 ">
                                                                        ...
                                                                        <div class="classBtn">
                                                                            @foreach ($shipSchedule['ship_class'] as $ferryPrice)
                                                                                ...
                                                                                data-ship_name="{{ $ferryPrice->ferry_name ?? 'Unknown' }}"
                                                                                data-ship_id="{{ $ferryPrice->ferry_id ?? 'N/A' }}"
                                                                                class="btn {{ $ferryPrice->class_name ?? 'Standard' }}  ferry-btn2 mb-2">
                                                                                    <p class="text-white mb-0">
                                                                                        {{ $ferryPrice->class_name ?? 'Standard' }}
                                                                                    </p>
                                                                                    <p class="text-white mb-0">
                                                        ...
                                                        @if ($shipSchedule['ship_name'] == 'Nautika')
                                                            <div class="ferryCard ferrySearch mb-3">
                                                                ...
                                                                <div class="ferryDetails ms-3">
                                                                    ...
                                                                    <div class="classBtn">
                                                                        <a href="#" id="{{ 'ferry_p_' . $key + 1 }}" data-ferryschedule-id="{{ $shipSchedule['id'] }}" data-trip_id="{{ $shipSchedule['tripId'] }}" data-vessel_id="{{ $shipSchedule['vesselID'] }}" data-from="{{ $return_route_titles['from_location'] }}" data-to="{{ $return_route_titles['to_location'] }}" data-departure_time="{{ $shipSchedule['departure_time'] }}" data-arrival_time="{{ $shipSchedule['arrival_time'] ?? 'N/A' }}" data-class-title="Premium" data-class_id="pClass" data-price="{{ $shipSchedule['fares']->pBaseFare }}" data-psf="50" data-avl_seat="{{ $shipSchedule['p_class_seat_availibility'] }}" data-ship_name="Nautika" class="btn Premium ferry-btn3 mb-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                                        ...
                                                                        <a href="#" id="{{ 'ferry_b_' . $key + 1 }}" data-ferryschedule-id="{{ $shipSchedule['id'] }}" data-trip_id="{{ $shipSchedule['tripId'] }}" data-vessel_id="{{ $shipSchedule['vesselID'] }}" data-from="{{ $return_route_titles['from_location'] }}" data-to="{{ $return_route_titles['to_location'] }}" data-departure_time="{{ $shipSchedule['departure_time'] }}" data-arrival_time="{{ $shipSchedule['arrival_time'] ?? 'N/A' }}" data-class-title="Business" data-class_id="bClass" data-price="{{ $shipSchedule['fares']->bBaseFare }}" data-psf="50" data-avl_seat="{{ $shipSchedule['b_class_seat_availibility'] }}" data-ship_name="Nautika" class="btn Business ferry-btn3 mb-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                            ...
                                                            <div class="ferryCard ferrySearch mb-3">
                                                                ...
                                                                <div class="ferryDetails ms-3">
                                                                    ...
                                                                    <div class="classBtn">
                                                                        @if (isset($shipSchedule['ferry_prices']) && !empty($shipSchedule['ferry_prices']))
                                                                            @foreach ($shipSchedule['ferry_prices'] as $ferryPrice)
                                                                                <a href="#" id="{{ 'ferry_' . ($ferryPrice['class']['title'] ?? 'Standard') . '_' . $key + 1 }}" data-ferryschedule-id="{{ $shipSchedule['id'] }}" data-class_id="{{ $ferryPrice['class']['id'] ?? 'N/A' }}" data-from="{{ $return_route_titles['from_location'] }}" data-to="{{ $return_route_titles['to_location'] }}" data-departure_time="{{ date('H:i', strtotime($shipSchedule['departure_time'])) }}" data-arrival_time="{{ isset($shipSchedule['arrival_time']) ? date('H:i', strtotime($shipSchedule['arrival_time'])) : 'N/A' }}" data-class-title="{{ $ferryPrice['class']['title'] ?? 'Standard' }}" data-price="{{ $ferryPrice['price'] ?? 0 }}" data-psf="{{ $ferryPrice['psf'] ?? 50 }}" data-avl_seat="{{ $ferryPrice['seat'] ?? 0 }}" data-ship_name="{{ $shipSchedule['ship']['title'] ?? 'Unknown' }}" data-ship_id="{{ $shipSchedule['ship_id'] ?? 'N/A' }}" class="btn {{ $ferryPrice['class']['title'] ?? 'Standard' }} ferry-btn3 mb-2">
                                                                                    <p class="text-white mb-0">{{ $ferryPrice['class']['title'] ?? 'Standard' }}</p>
                                                                                    <p class="text-white mb-0">₹ {{ $ferryPrice['price'] ?? 0 }}</p>
                                                                                    <p class="text-white mb-0">Seat: {{ $ferryPrice['seat'] ?? 0 }}</p>
                                                                                    <p class="bg-green-text-white mb-0">Book Now</p>
                                                                                </a>
                                                                            @endforeach
                                                        ...
                                                        @elseif($shipSchedule['ship_name'] == 'Green Ocean 1' || $shipSchedule['ship_name'] == 'Green Ocean 2')
                                                            <div class="ferryCard ferrySearch mb-3">
                                                                ...
                                                                <div class="ferryDetails ms-3">
                                                                    ...
                                                                    <div class="classBtn">
                                                                        @foreach ($shipSchedule['ship_class'] as $ferryPrice)
                                                                            <a href="#" id="{{ 'ferry_' . ($ferryPrice->class_name ?? 'Standard') . '_' . $key + 1 }}" data-ferryschedule-id="{{ $ferryPrice->route_id ?? 'N/A' }}" data-class_id="{{ $ferryPrice->class_id ?? 'N/A' }}" data-from="{{ $return_route_titles['from_location'] }}" data-to="{{ $return_route_titles['to_location'] }}" data-departure_time="{{ date('H:i', strtotime($shipSchedule['departure_time'])) }}" data-arrival_time="{{ isset($shipSchedule['arrival_time']) ? date('H:i', strtotime($shipSchedule['arrival_time'])) : 'N/A' }}" data-class-title="{{ $ferryPrice->class_name ?? 'Standard' }}" data-price="{{ $ferryPrice->adult_seat_rate ?? 0 }}" data-psf="{{ $ferryPrice->port_fee ?? 0 }}" data-avl_seat="{{ $ferryPrice->seat_available ?? 0 }}" data-ship_name="{{ $ferryPrice->ferry_name ?? 'Unknown' }}" data-ship_id="{{ $ferryPrice->ferry_id ?? 'N/A' }}" class="btn {{ $ferryPrice->class_name ?? 'Standard' }} ferry-btn3 mb-2">
...
@push('js')
    ...
    document.querySelectorAll("#confirm_seats").forEach(btn => {
        ...
        function customizeGOLayout(shipName) {
            
            if (shipName == 'Green Ocean 1') {
                $("#modalGreenOceanSeat .seat-layout").removeClass('ship_1');
                $("#modalGreenOceanSeat .seat-layout").removeClass('ship_2');
                $("#modalGreenOceanSeat .seat-layout").addClass('ship_1');

                $("#modalGreenOceanSeat .seat-layout .col-xs-3").each(function(El){
                ...
                $("#modalGreenOceanSeat .seat-layout").removeClass('ship_1');
                $("#modalGreenOceanSeat .seat-layout").removeClass('ship_2');
                $("#modalGreenOceanSeat .seat-layout").addClass('ship_2');
            }
        ...
        $(document).ready(function() {
            ...
            // scroll to search result on load
            $("html, body").animate({ 
                scrollTop: $('.searchResultsPage').offset().top 
            }, 1000); 
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        @if (request('trip_type') == 2)
                            // Round trip - store departure details and switch to return tab
                            var ferryScheduleId = element.data('ferryschedule-id');
                            var shipId = element.data('ship_id');
                            var classId = element.data('class_id');
                            var tripId = element.data('trip_id');
                        ...
                        @endif
                            ...
                            if (shipName.indexOf(gShipName) == 0) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(seatRes) {
                                        $("#modalGreenOceanSeat .seat-layout").empty();
                                        $("#modalGreenOceanSeat .seat-layout").data('trip-no', 2);
                                        $("#modalGreenOceanSeat .seat-layout").append(seatRes);
                                        $('#modalGreenOceanSeat').modal('show');
                                    }
                                });
            ...
            $("#modalGreenOceanSeat").on("click", ".btn.onewaysel", function(){
                var curEl = $(this);
                ...
                if (curTripNo == 1) {
                    if (curEl.hasClass('selected')) {
                        ...
                        curEl.parents('.seat-layout').find('.btn.onewaysel.selected').each(function(index) {
            ...
            $(document).on('click', "#confirm_seats", function() {
                ...
                if (curEl.parents('.modal-content').find('.luxury-down').length >= 1) { // for nautica
                    ...
                    curEl.parents('.modal-content').find('.seat-layout').find('.btn.onewaysel.selected').each(function(index) {
                        selectedTotalSeats++;
