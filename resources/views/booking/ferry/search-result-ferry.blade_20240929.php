...
@section('content')
  ...
  {{-- <div class="text-center loaderDiv">
    <img src="{{ asset('assets/images/rudder.gif') }}" width="80">
        ...
        {{-- ================== Green Ocean 1 Modal ============================== --}}
        <div class="modal fade" id="exampleModalGreenOcean1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Book Seat</h1>
                    ...
                    <div class="modal-body p-0">
                        ...
                        <div class="position-relative h-100 m-auto" id="g-o-1-economy" style="width: 90%;">
                            <div class="position-absolute luxury-down">
                                <div class="position-relative h-100 " style="width: 90%; margin: 0px auto;">
                                    <div class="position-absolute " style="top: 1%;">
                                        <div><span class="seat luxury 2A">2A</span><span
                        ...
                        <div class="position-relative h-100 m-auto" id="g-o-1-premium" style="width: 90%;">
                            <div class="position-absolute luxury-down">
                                <div class="position-relative h-100 " style="width: 82%; margin: 0px auto;">
                        ...
                        <div class="position-relative h-100 m-auto" id="g-o-1-royal" style="width: 90%;">
                            <div class="position-absolute luxury-down">
                                <div class="position-relative h-100 " style="width: 82%; margin: 0px auto;">
                                                                    ...
                                                                    <div class="classBtn">
                                                                        @foreach ($shipSchedule['ship_class'] as $ferryPrice)
                                                                            <a href="#"
                                                                                ...
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#exampleModalGreenOcean1"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#nautika_proceed").on('click', function() {
                ...
                let modalTripNo = '';
                $(this).parents('.modal-content').find('.luxury-down').find('.seat.selected').each(function(index) {
                    selectedTotalSeats++;
