...
<body>
    <div class="container">
        ...
        <a href="http://uat.bookmyferry.in/green-ocean-ticket/{{ $booking_data->pnr_id }}">Click to download the ticket{{ $booking_data->pnr_id }}</a>
        ...
        <div class="section">
            ...
            <p>If you need to modify or cancel your booking, please reply to this email or contact us at <a href="mailto:andamanferrybookings@gmail.com">andamanferrybookings@gmail.com</a>. Please note that any modifications or cancellations will be subject to our refund and cancellation policy available on our website.</p>
        </div>

        <div class="footer">
            <p>Thank you for using <a href="https://andamanferrybooking.com">andamanferrybooking.com</a></p>
            <p><strong>Contact Details:</strong> Nishad, <a href="mailto:andamanferrybookings@gmail.com">andamanferrybookings@gmail.com</a>, 9679061419/9933281206 </p>
        </div>
    </div>
</body>
</html>
